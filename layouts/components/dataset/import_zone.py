...
# import pandas as pd
# from app import app, alert, col_dataset_name, storage, store_id, get_dataframe, save_dataframe
...
#     return [data.get(col_dataset_name, "Data not yet imported."), up_default]
